...
| ------------------------------------- | ----- | ------------------------- |
| Voice Profile (`promptMode: "voice"`) | ✅    | `97f6835d8`               |
| Instant routing (bypass LLM)          | ✅    | `97f6835d8` + `86ecf86b8` |
| Conversation router (`disableTools`)  | ✅    | `97f6835d8`               |
| TTS sanitizer (strip markdown)        | ✅    | `86ecf86b8`               |
| Voice prompt rafforzato               | ✅    | `86ecf86b8`               |
...
| Pattern regex                                                                       | Trigger esempi                                    | Risposta                                                                               |
| ----------------------------------------------------------------------------------- | ------------------------------------------------- | -------------------------------------------------------------------------------------- |
| `^(ciao\|hey\|ehi\|salve\|buongiorno\|buonasera\|ehila\|oh ciao)(\s\|$)`            | "ciao", "ehi", "buongiorno"                       | random: "Ciao!", "Ehi, ciao!", "Ciao, dimmi tutto!", "Eccomi, dimmi!"                  |
| `^(grazie\|ti ringrazio\|perfetto grazie)`                                          | "grazie", "grazie mille"                          | random: "Di niente!", "Figurati!", "Prego!"                                            |
| `^(arrivederci\|ciao ciao\|ci vediamo\|a presto\|a dopo\|addio\|buonanotte)(\s\|$)` | "arrivederci", "a dopo"                           | random: "Ciao, a presto!", "A dopo!"                                                   |
| `(chi sei\|come ti chiami\|qual e il tuo nome\|il tuo nome)`                        | "chi sei", "come ti chiami", "qual e il tuo nome" | random: "Sono il tuo assistente vocale OpenClaw!", "Sono OpenClaw, il tuo assistente!" |
| `^(come stai\|tutto bene\|come va)`                                                 | "come stai", "come va"                            | random: "Tutto bene, grazie!", "Alla grande!"                                          |
| `(che ora e\|che ore sono\|dimmi lora\|sai lora)`                                   | "che ore sono"                                    | dinamico: "Sono le HH:MM."                                                             |
| `(che giorno e\|che data e\|data di oggi)`                                          | "che giorno e oggi"                               | dinamico: "Oggi e [data]."                                                             |
| `(che tempo fa\|meteo\|previsioni\|piove\|piovera\|fara caldo\|temperatura fuori)`  | "che tempo fa", "piove?"                          | random: "Non ho accesso al meteo..."                                                   |
